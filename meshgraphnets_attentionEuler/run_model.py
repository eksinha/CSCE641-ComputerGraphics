...
from meshgraphnets_attentionEuler import cfd_eval
from meshgraphnets_attentionEuler import cfd_model
from meshgraphnets_attentionEuler import cloth_eval
from meshgraphnets_attentionEuler import cloth_model
from meshgraphnets_attentionEuler import core_model
from meshgraphnets_attentionEuler import dataset
...
PARAMETERS = {
    ...
    'cloth': dict(noise=0.003, gamma=0.1, field='world_pos', history=True,
                  size=3, batch=1000, model=cloth_model, evaluator=cloth_eval)
}
